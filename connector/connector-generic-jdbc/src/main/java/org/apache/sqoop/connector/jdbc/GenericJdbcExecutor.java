...
public abstract class GenericJdbcExecutor implements IBaseJdbcExecutor{

    private static final Logger LOG =
            Logger.getLogger(CommonJdbcExecutor.class);

    protected Connection connection;
    protected PreparedStatement preparedStatement;

    public GenericJdbcExecutor(){}
    ...
    protected abstract String getInsertQuery(String fromTable, String toTable);

    public void migrateData(String fromTable, String toTable) {
        String insertQuery = getInsertQuery(fromTable, toTable);
        Statement stmt = null;
    ...
    protected void logSQLException(SQLException e, String message) {
        LOG.error(message, e);
